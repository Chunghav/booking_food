...
<h1 class="text-dark ml-5">Introduction</h1>
        <hr class="line">



        <h1 class="text-dark ml-5">Contact</h1>
        <hr class="line">

    <div class="contact  ml-5">
        <h4><b>You can contact us by : </b></h4>
        ...
        </svg><a class="text-dark" href="#"> Booking Food </a></li>
        ...
        </svg><a class="text-dark" href="#"> booking.food@gmail.com </a></li>
        ...
        </svg><a class="text-dark" href="#"> Booking Food Page </a></li>
        ...
        </svg><a class="text-dark" href="#"> Booking Food Channel </a></li>
        ...
        </svg><a class="text-dark" href="#"> 012 432 567</a> / <a class="text-dark" href="#">096 432 5677</a></li>
